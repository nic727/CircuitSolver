...
public class GridPanel {// extends JPanel {
	...
	public static ArrayList<Integer> line_specification;
	ImageIcon map;

	public GridPanel(JPanel p) {
		LineHolder.lines = new ArrayList<Line2D.Float>();
		line_specification = new ArrayList<Integer>();
		generateMap(p);
	}
	...
	public void generateMap(JPanel p) {
		...
		panel_map.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.LOWERED));
		...
		map = new ImageIcon("src/display/circuit_solver/images/map.png");
